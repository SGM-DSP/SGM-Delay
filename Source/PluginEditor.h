...
class SGMDelayAudioProcessorEditor final : public juce::AudioProcessorEditor
{
public:
    explicit SGMDelayAudioProcessorEditor (SGMDelayAudioProcessor&);
    ~SGMDelayAudioProcessorEditor() override = default;
...
private:
    ...
    struct Knob
    {
        ...
        Group group = Group::delay;
        bool primary = false;
    };

    SGMDelayAudioProcessor& processor;
    juce::OwnedArray<Knob> knobs;
    juce::ComboBox timeDivisionBox;
    juce::ToggleButton pingPongButton;
    juce::ToggleButton freezeButton;
    std::unique_ptr<ComboBoxAttachment> timeDivisionAttachment;
    ...
    void layoutDelayGroup (juce::Rectangle<int> bounds);

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SGMDelayAudioProcessorEditor)
};
